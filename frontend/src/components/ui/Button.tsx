  ...
  'inline-flex items-center justify-center rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline: 'border border-gray-600 bg-transparent text-gray-300 shadow-sm hover:bg-gray-800 hover:text-white focus-visible:ring-gray-500',
        secondary: 'bg-gray-700 text-gray-100 shadow-sm hover:bg-gray-600 focus-visible:ring-gray-500',
